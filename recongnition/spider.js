...
// const path = path.resolve(__dirname, '../public/images/riceBlast/')
...
// const path = path.resolve(__dirname, '../public/images/bacterialBlight/')
...
const path = path.resolve(__dirname, '../public/images/sclerotialBlight/')
